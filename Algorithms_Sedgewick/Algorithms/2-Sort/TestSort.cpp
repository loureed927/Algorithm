...
int main()
{
    ...
    // heap sort
    // array str[0] is unused.
    std::string str[] = {"", "S", "O", "R", "T", "E", "X", "A", "M", "P", "L", "E" };
    std::vector<std::string> testDataH(str, str + 12);
    HeapSort(testDataH);
    std::vector<std::string> testDataHH(testDataH.begin()+1, testDataH.end());


    // validate and print result
    assert(isSorted(testDataHH));
    show(testDataHH);
}
